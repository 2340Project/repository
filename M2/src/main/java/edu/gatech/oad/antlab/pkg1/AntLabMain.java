 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Austin Duncan ");
		  toPrint += p1.toString("aduncan37");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Yamin Mousselli");
		  toPrint += p2.toString("ymousselli3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Isaac Khai Ren Chua");
		  toPrint += p3.toString("ichua3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Brian Haas");
                  toPrint += p4.toString("bhaas3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Danie Tadesse");
                  toPrint += p5.toString("dtadesse6");
